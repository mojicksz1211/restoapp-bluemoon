...
class SocketService {
  ...
  // This client's branch id — sent with every join_* so the backend keeps each
  // branch's realtime traffic in its own room. Loaded lazily from prefs.
  ...
  static Future<void> initialize() async {
    ...
    try {
      ...
      _socket!.onConnect((_) {
        ...
        // Re-join role rooms if needed, scoped to this branch.
